...
def function1():
    ...
    x =  np.arange(1,13).reshape(6, -1) # Write your code here 
...
def function8():
    ...
    x = np.zeros(10, dtype=np.uint).reshape(2, 5) + 6 #write your code here
...
def function18():
    ...
    x = np.intersect1d(students, piaic).size # Write you code Here
    return x
